...
The probabilities were used to estimate the distribution of gene conversion tract length from HiFi PacBio datasets. For more details, please see Charmouh et al. 2024, Estimating gene conversion tract length and rate from PacBio HiFi data, BioRXiv, https://doi.org/10.1101/2024.07.05.601865. 
